...
public final class BalloonItemAnimator extends SimpleItemAnimator {
    ...
    private void animateRemoveImpl(final RecyclerView.ViewHolder holder) {
        ...
        animation.setDuration(getRemoveDuration()).alpha(0).translationX(view.getMeasuredWidth()).setListener(
